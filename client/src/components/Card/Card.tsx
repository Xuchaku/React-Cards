...
const Card: FC<CardPropsType> = ({ data, isMore, setSelected, setModal }) => {
  ...
  return (
    ...
    >
      ...
      {isMore ? (
        <div className={`Card__wrapper Card__wrapper-abs`}>
          <button
          ...
          <div className="Card__columns">
            <div className="Card__info Card__row">
              ...
              <p className="Card__text Card__link Card__trunc">{data.phone}</p>
            </div>
            <div className="Card__info Card__row">
              <p className="Card__punkt">Почта:</p>
              <p className="Card__text Card__link Card__trunc">{data.email}</p>
            </div>
            <div className="Card__info Card__row">
